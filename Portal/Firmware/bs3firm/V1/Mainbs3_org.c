    ...
    while ( 1 )
    {
        ...
        */
        if ( SMH->ena )
        {
            ...
            case 2 :
                // Pollen auf Startposition Huepferfuss ab
                if ( aktpos >= SMH->startab )
                {
                    if ( (SMH->posunten - SMH->istpos) > 0 )
                    {
                        SM1->mod = SMH->smzplus;
                    }
                    else
