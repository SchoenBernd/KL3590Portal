...
03.05.2012     A. Kretschmann    (markiert mit 030412)
Beim Programmieren (Leerfahrten) per Tastendrücken die SM Geschwindigkeit
vom PC104 gesteuert veraenderbar machen.
