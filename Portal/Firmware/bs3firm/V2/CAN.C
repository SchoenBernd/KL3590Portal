...
void CAN_vInit(void)
{
  ...
  CAN_OBJ[0].UAR  = 0x4026;    // set Upper Arbitration Register
  ...
  CAN_OBJ[1].MCR  = 0x5595;    // set Message Control Register

  /// message direction is receive
  /// standard 11-bit identifier
  CAN_OBJ[1].MCFG = 0x00;      // set Message Configuration Register

  CAN_OBJ[1].UAR  = 0x6006;    // set Upper Arbitration Register
  ...
  CAN_OBJ[2].MCR  = 0x5595;    // set Message Control Register

  /// message direction is receive
  /// standard 11-bit identifier
  CAN_OBJ[2].MCFG = 0x00;      // set Message Configuration Register

  CAN_OBJ[2].UAR  = 0x8006;    // set Upper Arbitration Register
  ...
  CAN_OBJ[3].MCR  = 0x5595;    // set Message Control Register

  /// message direction is receive
  /// standard 11-bit identifier
  CAN_OBJ[3].MCFG = 0x00;      // set Message Configuration Register

  CAN_OBJ[3].UAR  = 0xA006;    // set Upper Arbitration Register
  ...
  CAN_OBJ[4].MCR  = 0x5595;    // set Message Control Register

  /// message direction is receive
  /// standard 11-bit identifier
  CAN_OBJ[4].MCFG = 0x00;      // set Message Configuration Register

  CAN_OBJ[4].UAR  = 0xC006;    // set Upper Arbitration Register
  ...
  CAN_OBJ[5].UAR  = 0xE006;    // set Upper Arbitration Register
  ...
  CAN_OBJ[6].UAR  = 0x0007;    // set Upper Arbitration Register
  ...
  CAN_OBJ[7].UAR  = 0x2007;    // set Upper Arbitration Register
  ...
  CAN_OBJ[8].UAR  = 0x4007;    // set Upper Arbitration Register
  ...
  CAN_OBJ[9].MCR  = 0x5695;    // set Message Control Register

  /// message direction is transmit
  /// standard 11-bit identifier
  /// 6 valid data bytes
  CAN_OBJ[9].MCFG = 0x68;      // set Message Configuration Register

  CAN_OBJ[9].UAR  = 0x4046;    // set Upper Arbitration Register
  CAN_OBJ[9].LAR  = 0x0000;    // set Lower Arbitration Register

  CAN_OBJ[9].Data[0] = 0x00;   // set data byte 0
  CAN_OBJ[9].Data[1] = 0x00;   // set data byte 1
  CAN_OBJ[9].Data[2] = 0x00;   // set data byte 2
  CAN_OBJ[9].Data[3] = 0x00;   // set data byte 3
  CAN_OBJ[9].Data[4] = 0x00;   // set data byte 4
  CAN_OBJ[9].Data[5] = 0x00;   // set data byte 5
